<div class="section p-no-top">
    <div class="container">
        <div>
            <ul class="lg-tabs">
                <li class="active">
                    <a href="#profile_profile" data-toggle="tab" data-wow-delay="0.1s">
        ...
        <div class="tab-content lg-tab-content">
            <div class="tab-pane active in" id="profile_profile"><div class="row">
                    <div class="col-md-7 fadeIn about_uns_time">
                        <p class="">Wir sind ein Lack- und Aufbereitungsbetrieb!</p><p>

                        </p><p class="">Schon an unserem letzten Standort in Landau als „L&amp;L United GmbH“ konnten wir unsere Kunden mit unserer Qualität für professionelle Autoaufbereitung, Pflege und Smart-Repair für uns begeistern und zufrieden stellen.</p>

                        <p class="">Durch den stetig wachsenden Kundenkreis und dem daraus entstehenden Platzmangel, dürfen wir mit Freude verkünden, dass wir seit dem 01.04.2014 in der Großen Ahlmühle 11, 76865 Rohrbach zu finden sind. Nicht nur unser Standort hat sich geändert sondern auch unsere Firmierung, ab sofort sind wir die Car-Doc GmbH.</p>

                        <p class="">Jetzt, mit unserem noch größeren und schöneren Standort in Rohrbach, sowie durch die Anschaffung einer großen Lackierkabine sind wir jetzt in der Lage LKW und Reisebusse zu lackieren.</p>

                        <p class="">Seit 8 Jahren schätzt uns Mercedes-Benz als zuverlässiger Partner in der Aufbereitung und mit unseren zahlreichen Waschanlagen und Aufbereitungsplätze in den Mercedes Niederlassungen Mannheim, Heidelberg, Landau und Wörth, sind wir für jede Herausforderung bereit!</p>

                        <p class="">Für unsere Arbeiten im Bereich Lack, Aufbereitung und Pflege verwenden wir nur Markenprodukte in höchster Qualität, denn nichts ist uns lieber wie ein zufriedener Kunde.</p>

                        <p class="">Überzeugen Sie sich doch einmal selbst von unseren Leistungen zu fairen Preisen!</p>
                    </div>
                ...
                </div></div><div class="tab-pane  in" id="profile_hours"><div class="row"><!--?php
                /*
                ...
                ?-->
                    ...
                    </div></div></div><div class="tab-pane  in" id="profile_contacts"><div class="row"><!--?php
                    /*
                     * To change this template, choose Tools | Templates
                     * and open the template in the editor.
                     */
                ...
                </div></div><div class="tab-pane  in" id="profile_skills"><div class="row">
