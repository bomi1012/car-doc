...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="bs-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right" id="nav">
                    ...
                    <li class="dropdown">
                        <a href="#s1" class="wow fadeIn" data-wow-delay="0.15s">Über uns</a>
                    </li>
                    <li class="dropdown">
                        <a href="#s33" class="wow fadeIn" data-wow-delay="0.2s">Dinstleistungen</a>
                    </li>
                    <li class="dropdown">
    ...
    <div class="section p-no-top">
        <div class="container">
            ...
            <ul class="lg-tabs">
                <li class="active">
                    <a href="#responsive" data-toggle="tab" data-wow-delay="1s">
                        <i class="fa fa-university"></i>
                        <h3>Über uns</h3>
                    </a>
                </li>                
                <li class="">
                    <a href="#font" data-toggle="tab">
                        <i class="fa fa-car"></i>
                ...
                <div class="tab-pane  animated fadeIn" id="font">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-block">Font Awesome gives you scalable vector icons that can instantly be customized â€” size, color, drop shadow, and anything that can be done with the power of CSS.</p>
  ...
  <!-- About us section -->
        ...
        <div class="container">
            ...
            <div class="section auto-height">
                ...
                <div class="knobs" id="gk">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <input class=" greenKnob" value="93">
                            <h3>Html5/CSS3</h3>
                            <p>We can make wonderful design through these possibilities - HTML5 and CSS3.</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                ...
                <div class="knobs " id="yk">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <input class="yellowKnob" value="94">
                            <h3>Html5/CSS3</h3>
                            <p>We can make wonderful design through these possibilities - HTML5 and CSS3.</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                ...
                <div class="knobs" id="lbk">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <input class="redKnob" value="100">
                            <h3>Flexibilität</h3>
                            <p>Ohne Wochenende und alle 24 Stunden</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <input class="redKnob" value="100">
                            <h3>Qualität</h3>
                            <p>komputer diagnostic </p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <input class="redKnob" value="100">
                            <h3>Noch was</h3>
                            <p>Einbishen blablabla</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <input class="redKnob" value="100">
                            <h3> Kundenorientierung</h3>
                            <p>У нас ничего не ломается</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Our team Section -->
    <div class="section" id="s33">
        <div class="container">
            <h2 class="lg-title lg-title-border">Was wir bieten</h2>
            <p class="sub-title">
                An diese Stelle wird kurz beschrieben, was wir machen... Ein bishen Text. Man muss mal hier was schreiben
            </p>
                ...
                <div class="col-md-6">
                    <div class="content-box">
                        ...
                        <div class="body wow fadeIn">
                            <p>"Itâ€™s just brilliant. I will recommend the product to everyone I know!"</p>
                            <h4>Adele Taylor
                ...
                <div class="col-md-6">
                    <div class="content-box">
                        ...
                        <div class="body wow fadeIn" data-wow-delay="0.5s">
                            <p>"Iâ€™m really glad these guys got that product out there. Iâ€™ve bought it and now think perhaps I should have invested!"</p>
                            <h4>Nicole Perry
                                <em>CIO of Google</em>
                            </h4>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="content-box">
                        ...
                        <div class="body wow fadeIn" data-wow-delay="0.25s">
                            <p>"What a product. Why didnâ€™t someone think of it sooner?"</p>
                            <h4>Ben Berry
                ...
                <div class="col-md-6">
                    <div class="content-box">
                        ...
                        <div class="body wow fadeIn" data-wow-delay="0.75s">
                            <p>"Get out there and buy it if youâ€™re a customer and stock it if youâ€™re a retailer â€“ youâ€™d be mad not to!"</p>
                            <h4>Jenny Jonson
